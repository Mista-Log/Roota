      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <motion.aside
            ...
            className="relative z-50 h-full w-72 flex-col overflow-y-auto border-r border-[#d6e4dc] bg-[#edf6f1] text-slate-900"
          >
            <div className="flex items-center justify-between border-b border-[#d6e4dc] bg-[#0b5d4b] px-4 py-4 text-white">
              ...
              <button onClick={onClose} className="rounded-md p-2 text-white">
                <X size={18} />
              </button>
            </div>
