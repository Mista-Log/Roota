      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <motion.aside
            ...
            className="relative z-50 h-full w-72 flex-col overflow-y-auto border-r border-[#e6efe6] bg-[#f8faf8] text-slate-900"
          >
            <div className="flex items-center justify-between border-b border-[#e6efe6] px-6 py-4">
              <Link to="/employer/dashboard" className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">Employer Workspace</div>
                </div>
              </Link>
