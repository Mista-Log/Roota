...
const faqs = [
  { question: 'How do I get started as an employer?', answer: 'Sign up as an employer, complete your company profile, and start posting roles or browsing talent.', category: 'Getting Started' },
  { question: 'How does employer trust score work?', answer: 'Your trust score is based on payroll consistency, dispute resolution, hiring quality, and compliance.', category: 'Trust Score' },
  { question: 'Can I pay my team from the wallet?', answer: 'Yes, employers can pay workers individually or in bulk from the wallet flow.', category: 'Payments' },
  { question: 'How are payroll payments processed?', answer: 'Payments are processed securely and tracked in real time.', category: 'Payroll' },
  { question: 'Is my company data secure?', answer: 'We use industry-standard encryption and security protocols to protect your data.', category: 'Security' },
  { question: 'How do I increase my trust score?', answer: 'Keep payroll accurate, resolve disputes quickly, and maintain strong hiring outcomes.', category: 'Trust Score' },
];
...
const supportChannels = [
  ...
  { icon: MessageSquare, title: 'Community Forum', description: 'Connect with other employers', contact: 'Join our Discord community', avgResponse: 'Peer support' },
];

const ticketStatuses = [
  { id: 'TICKET-2401', subject: 'Payroll not processed', status: 'resolved', date: 'May 10, 2026' },
  { id: 'TICKET-2398', subject: 'Company verification pending', status: 'in-progress', date: 'May 8, 2026' },
  { id: 'TICKET-2395', subject: 'Talent listing issue', status: 'resolved', date: 'May 5, 2026' },
];
