...
const mockFinancialSummary = [
  ...
  { label: 'Pending Payouts', value: 3200.0, meta: 'Processing: 2', icon: ReceiptText },
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.3fr_1fr]">
        <motion.section variants={cardVariants} initial="hidden" animate="visible" transition={{ delay: 0.2 }} className="rounded-2xl border border-border bg-card px-6 py-6 shadow-sm">
          <div className="mb-6 flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-slate-900">Your earnings wallet</h3>
              <p className="text-sm text-muted">Withdraw funds and manage payouts</p>
            </div>
          ...
          <div className="rounded-[24px] bg-gradient-to-br from-primary-dark to-[#12493d] p-8 text-white shadow-sm">
            <div className="mb-10 flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-white/75">Roota Worker Finance</p>
        ...
        <motion.section variants={cardVariants} initial="hidden" animate="visible" transition={{ delay: 0.28 }} className="rounded-2xl border border-border bg-card px-6 py-6 shadow-sm">
          <div className="mb-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button onClick={() => navigate('/worker/transactions')} className="text-xs font-semibold text-primary-dark hover:text-primary">View All Transactions</button>
