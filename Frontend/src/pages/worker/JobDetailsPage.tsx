  ...
  useEffect(() => {
    const fetchJob = async () => {
      ...
      try {
        ...
        console.warn('Failed to fetch job, using fallback:', error);
        setJob({
          id: jobId,
          title: 'Sample Job',
          company: 'Acme Corp',
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-border bg-card p-6">
        ...
        <ul className="mt-3 space-y-2 text-sm text-slate-700">
          ...
          <li>
            <strong>Posted:</strong> {job.posted || '2 days ago'}
          </li>
          <li>
      ...
      <section className="rounded-2xl border border-border bg-card p-6">
        ...
        <p className="mt-2 text-sm text-muted">
          Click the Apply button to submit your profile and a cover note. Your trust score and recent work history
          will be included.
        </p>
        <div className="mt-4">
          <button
            ...
            className="rounded-lg bg-primary-dark px-4 py-2 font-semibold text-white hover:bg-primary-dark/90"
          >
            Apply to this job
          </button>
        </div>
