...
const mockTransactions: TransactionItem[] = [
  {
    id: 'tx_1',
    description: 'Payroll - Project X',
    amount: '+$4,200.00',
    status: 'SUCCESS',
    type: 'incoming',
    date: 'Oct 24, 2023',
    method: 'Wallet credit',
    reference: 'RXP-2402-012',
  ...
  },
  {
    ...
    reference: 'WDR-2202-091',
    counterpart: 'GTB Nigeria',
  },
  {
    id: 'tx_3',
    ...
    type: 'incoming',
    date: 'Oct 20, 2023',
    method: 'Reward payout',
    reference: 'BON-2002-010',
    counterpart: 'Roota Rewards',
  },
  {
    id: 'tx_4',
    ...
    date: 'Oct 18, 2023',
    method: 'Card charge',
    reference: 'SUB-1802-043',
    counterpart: 'Roota Premium',
  },
];
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-muted">Filter and inspect complete transaction details</p>
        ...
        <div className="mt-5 grid grid-cols-1 gap-3 md:grid-cols-[1.2fr_0.7fr_0.7fr]">
          ...
          <select
            ...
            className="w-full rounded-xl border border-border bg-white px-3 py-2.5 text-sm outline-none transition-colors focus:border-primary-dark"
          >
          ...
          <select
            value={typeFilter}
            onChange={(e) => setTypeFilter(e.target.value as 'ALL' | 'incoming' | 'outgoing')}
            className="w-full rounded-xl border border-border bg-white px-3 py-2.5 text-sm outline-none transition-colors focus:border-primary-dark"
          >
